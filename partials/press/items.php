...
$press_items = [
    ...
    [
        ...
        'country' => 'Online',
        'language' => 'English',
        'outlet' => 'Music Circuit',
        'date' => 'Jul 10, 2026',
        'icon' => 'fas fa-microchip',
        'icon_color' => 'text-success',
        'title' => "Local AI Music Generation in 10s: OBSIDIAN Neural's Free CPU Plugin",
        'excerpt' => 'OBSIDIAN Neural enters beta with a Local Edition running Stable Audio 3 Medium fully offline on CPU, generating usable loops in roughly 10 to 11 seconds with no GPU or internet required after setup.',
    ],
...
$publication_count = count($press_items);
$countries         = array_unique(array_filter(array_column($press_items, 'country')));
$country_count     = count($countries);
$languages         = array_unique(array_filter(array_column($press_items, 'language')));
