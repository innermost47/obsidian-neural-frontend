<div class="bg-white/[0.03] backdrop-blur-md border border-white/[0.06] rounded-3xl p-6 md:p-8 relative overflow-hidden">
    ...
    <div class="relative z-10">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl md:text-3xl font-extrabold tracking-tight text-white mb-1">Set up account access</h1>
            <p class="text-sm text-gray-500">Forgot your password, or just bought the Local Edition? Enter your email and we'll send you a link to set it.</p>
        </div>
        ...
        <div class="mb-6 p-4 rounded-2xl bg-track5/[0.08] border border-track5/20 text-sm text-gray-400">
            <i class="fas fa-microchip mr-2 text-track5"></i>Bought the Local Edition? Use the email from your purchase — your license is already linked to it.
        </div>
        <form id="forgot-password-form">
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-600 mt-2">
                    <i class="fas fa-info-circle mr-1"></i>We'll send a secure link to this email
                </p>
            </div>
            <button type="submit" id="submit-btn"
                ...
                <span id="submit-text">Send link</span>
            </button>
        </form>
        ...
        <div class="text-center">
            <p class="text-sm text-gray-500 mb-3">Already have access?</p>
            <a href="login.php"
