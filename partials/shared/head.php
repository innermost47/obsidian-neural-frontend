...
<head>
    ...
    <meta
        name="keywords"
        content="AI VST plugin, AI music generation VST3, live performance AI audio, Stable Audio VST, AI DAW plugin, OBSIDIAN Neural, InnerMost47, sketch to audio, draw to audio VST, DePIN, GPU provider network, passive income GPU, distributed AI audio, proof of work music" />
    ...
    <meta
        ...
        content="First VST for AI music generation designed for live performance. 8-track sampler, 8 AI models. Presented at AES AIMLA 2025" />
    <meta
        property="og:image"
